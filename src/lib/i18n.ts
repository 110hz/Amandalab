...
export const content = {
  ...
  products: {
    ...
    items: [
      ...
      {
        name: { zh: '闪蝶雪椰', en: 'MORPHO COCONUT CREAM' },
        tag: { zh: '椰云款', en: 'Coconut' },
        productTag: 'coconut',
        overview: {
          zh: '采用天然进口椰子原料，无香精无色素，入口清爽干净，冰淇淋质感，对肠胃无负担，适合素食主义以及追求健康又不失口感的消费人群。',
          en: 'Made with natural imported coconut ingredients, no artificial flavors or colors. Clean and refreshing taste with ice cream texture, gentle on digestion. Perfect for vegans and health-conscious consumers who refuse to compromise on flavor.',
        },
        highlights: [
          { zh: '适配广泛', en: 'Wide Compatibility' },
          { zh: '茶饮 / 甜品 / 西快均适用', en: 'Tea / Desserts / Western cuisine' },
          { zh: '常温放置', en: 'Room Temperature' },
          { zh: '开封后可常温放置7天，缓解冷藏压力', en: '7 days at room temp after opening, eases cold storage pressure' },
          { zh: '素食配方', en: 'Vegan Formula' },
          { zh: '进口椰子原料，素食无负担', en: 'Imported coconut ingredients, vegan friendly' },
        ],
        specs: {
          name: { zh: '产品名称', en: 'Product Name' },
          nameValue: { zh: '闪蝶雪椰 / MORPHO COCONUT CREAM', en: 'MORPHO COCONUT CREAM' },
          spec: { zh: '产品规格', en: 'Specification' },
          specValue: '12 × 470ml',
          shelfLife: { zh: '保质期', en: 'Shelf Life' },
          shelfLifeValue: { zh: '9 个月', en: '9 months' },
        ...
        applications: [
          { zh: '茶饮系列', en: 'Tea Series' },
          { zh: '甜品系列', en: 'Dessert Series' },
          { zh: '西快系列', en: 'Western Café Series' },
          { zh: '果茶系列', en: 'Fruit Tea Series' },
        ],
      },
    ],
  ...
  about: {
    ...
    milestones: [
      ...
      { year: '2026', text: { zh: '闪蝶系列产品斩获iSEE全球创新奖银奖', en: 'MORPHO series wins iSEE Global Innovation Award Silver Prize' } },
    ],
    certifications: [
